...
{
    public class SteamControllerCollection : Dan200.Core.Util.IReadOnlyCollection<ISteamController>, IDisposable
    {
        ...
        private List<SteamController> m_controllers;
        ...
        public SteamControllerCollection(SDL2Window window, string[] actionSetNames, string[] digitalActionNames, string[] analogActionNames, string[] analogTriggerActionNames)
        {
            m_window = window;
            ...
            m_controllers = new List<SteamController>();
            App.CheckSteamworksResult("SteamController::Init", global::Steamworks.SteamController.Init());
            ...
            for (int i = 0; i < actionSetNames.Length; ++i)
            {
                ...
                m_actionSetHandles.Add(name, global::Steamworks.SteamController.GetActionSetHandle(name));
            }
            ...
            for (int i = 0; i < digitalActionNames.Length; ++i)
            {
                ...
                m_digitalActionHandles.Add(name, global::Steamworks.SteamController.GetDigitalActionHandle(name));
            }
            ...
            for (int i = 0; i < m_analogActionNames.Length; ++i)
            {
                ...
                m_analogActionHandles.Add(name, global::Steamworks.SteamController.GetAnalogActionHandle(name));
            }
        ...
        public void Dispose()
        {
            App.CheckSteamworksResult("SteamController::Shutdown", global::Steamworks.SteamController.Shutdown());
        }
        ...
        public void Update()
        {
            global::Steamworks.SteamController.RunFrame();
            DetectControllers();
        ...
        private void DetectControllers()
        {
            ...
            m_numControllerHandles = global::Steamworks.SteamController.GetConnectedControllers(m_controllerHandles);
            ...
            for (int i = 0; i < m_numControllerHandles; ++i)
            {
                ...
                if (match == null)
                {
                    m_controllers.Add(new SteamController(this, m_window, handle));
                }
            }
        }
    }
