...
{
    public class SteamworksSteamController : ISteamController
    {
        private SteamworksSteamControllerCollection m_owner;
        ...
        public string GetButtonPromptPath(string id, string actionSetID)
        {
            ...
            int numOrigins = SteamController.GetDigitalActionOrigins(
                m_handle,
