...
{
    public class GamepadInputOptionsState : OptionsState
    {
        ...
        {
            private Game m_game;
            private GamepadInputOptionsState m_state;

            public GamepadTypeOption(Game game, GamepadInputOptionsState state)
            {
                m_game = game;
                m_state = state;
            }
        ...
        public GamepadInputOptionsState(Game game) : base(game, "menus.gamepad_input_options.title", "levels/options.level")
        {
        }
