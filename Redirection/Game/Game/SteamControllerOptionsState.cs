...
{
    public class SteamControllerOptionsState : RobotOptionsState
    {
        ...
        public SteamControllerOptionsState(Game game) : base(game, "menus.steam_controller_input_options.title")
        {
